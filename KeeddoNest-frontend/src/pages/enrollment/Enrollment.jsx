    ...
    <section className="enroll-page">
      <div className="enroll-container">
          ...
          <div className="program-highlights">
            ...
            <div className="highlight-card offline-card">
              ...
              <div>
                ...
                <h4>Early Learning</h4> <p>Available in offline mode.</p> 
              </div> 
            </div> 
            <div className="highlight-card offline-card">
            ...
            <div className="highlight-card offline-card">
              ...
              <div>
                ...
                <h4>Learning Support</h4> <p>Available in offline mode.</p> 
              </div> 
            </div> 
            <div className="highlight-card offline-card">
              ...
              <div>
                ...
                <h4>Toddler Program</h4> <p>Available in offline mode.</p> 
              </div> 
            </div> 
            <div className="highlight-card offline-card">
        ...
        <div className="enroll-right">
          ...
          <p className="form-time">⏱ Takes less than 30 seconds to complete</p>
          ...
          >
            ...
            <select name="entry.1485140938" defaultValue="" required>
              ...
              <option value="Combo Programs">Combo Programs</option>
